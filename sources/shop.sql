...
This repository
 Star 0  Fork 0 code-examples/php-web-shop-code-examples
 branch: master   php-web-shop-code-examples / webshop / db_shop.sql
Marley code-examples on May 28 first commit
1 contributor
292 lines (244 sloc)  21.447 kb RawBlameHistory
-- phpMyAdmin SQL Dump
-- version 3.5.1
...
--
-- Host: localhost:8889
-- Generation Time: Aug 08, 2014 at 09:51 PM
