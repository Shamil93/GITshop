...
class Request {
    ...
    function __construct() {
        ...
        \ecommerce\base\RequestRegistry::setRequest( $this );    // кэшируем ее в классе Registry
    }
     ...
     * @param \ecommerce\command\Command $command
     */
    function setCommand( \ecommerce\command\Command $command ) {
