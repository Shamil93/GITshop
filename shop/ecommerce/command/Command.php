...
require_once( "ecommerce/view/utils/getNameServer.php" );
...
abstract class Command {
     ...
     */
    function execute( \ecommerce\controller\Request $request ) {
     ...
     * @return mixed
     */
    abstract function doExecute( \ecommerce\controller\Request $request );
    ...
    function reloadPage( $delay, $resource ) {
        $server = \ecommerce\view\utils\getNameServerWithExt().$resource;
        $delay = intval( $delay );
