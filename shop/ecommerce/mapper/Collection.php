...
require_once( "ecommerce/domain/Collections.php" );
...
//        echo "<tt><pre> Collection raw - ".print_r($this->total,true)."</pre></tt>";
    ...
    function add( \ecommerce\domain\DomainObject $object ) {
        $class = $this->targetClass();
        if( ! ( $object instanceof $class ) ) {
            throw new \ecommerce\base\AppException( "This is a {$class} collection" );
        }
        $this->notifyAccess();
...
//        echo "<tt><pre> getRow num - ".print_r($num,true)."</pre></tt>";
        ...
        if( isset( $this->objects[$num] ) ) { // если массив $objects содержит объект \ecommerce\domain\News
